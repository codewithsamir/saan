      ...
      <div className="relative max-w-6xl z-10 mx-auto touch-action-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviceCards.map((service, index) => (
            ...
            >
              <Card
                className={`relative bg-white/90 backdrop-blur-sm border-0 shadow-lg transition-all duration-300 ${
                  service.highlight
              ...
              >
                <CardHeader>
                  <motion.div
                    whileHover="hover" // Enable icon hover animation for all devices
